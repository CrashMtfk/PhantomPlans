        ...
        <div>
          <div className='container-fluid'>
            ...
            <div className="d-flex icons-container mb-4">
              <a href="https://www.instagram.com/restanta2.0/" target='_blank'><img src={instagramLogo} alt="" /></a>
              <a href="https://github.com/CrashMtfk" target='_blank'><img src={githubLogo} alt="" /></a>
              <a href="https://www.linkedin.com/in/rusclaudiu/" target='_blank'><img src={linkedInLogo} alt="" /></a>
            </div>
          </div>
        </div>
      </div>
